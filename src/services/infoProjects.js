const infoProjects = {
    ...
    softwareSkills: ['visual studio code', 'zeplin', 'photoshop', 'illustrator'],
    projects: [
        {
            id: 1,
            name: 'Eventos de Eventbrite con página detalle',
            description: 'Creación de una interfaz con un listado de eventos que se realizan en Madrid más su vista detalle. El objetivo principal del proyecto es poder explotar la API pública de Eventbrite.',
            urlGithub: 'https://github.com/irene-gomez/fairfax-m4-eventbrite-eventos',
            urlDemo: 'https://beta.adalab.es/fairfax-m4-eventbrite-eventos/#/',
            image: require('../img/projects/04-eventbrite.png'),
        },
        {
            id: 2,
            name: 'Buscador de personajes de Harry Potter',
            description: 'SPA creada con React que recoge los datos de una API pública. También se usa react-router-dom para implementar una página de detalle.',
            urlGithub: 'https://github.com/irene-gomez/f-m3-evaluacion-final-irenegf83',
            urlDemo: 'https://beta.adalab.es/f-m3-evaluacion-final-irenegf83/#/',
            image: require('../img/projects/05-harry-potter-character.png'),
        },
        {
            id: 3,
            name: 'Rock & code',
            description: 'Proyecto de web responsive. Orientado únicamente a la maquetación con HTML, CSS y SCSS.',
            urlGithub: 'https://github.com/irene-gomez/f-m1-rock-code',
            urlDemo: 'https://beta.adalab.es/f-m1-rock-code/',
        ...
        },
        {
            ...
            description: 'Refactorización de código heredado y migración de JavaScript a React.',
